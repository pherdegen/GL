/****************************************************
*                                                   *
*      TP_lib  pour Th�mes G�nie Logiciel  1 et 2   *
*                 GL1 + GL2							* 
*													*
*****************************************************
...
//	double montant ;
	...
	/* 1er argument = montant APRES d�duction de la remise */
...
#ifdef AGNES_VERSION
/**************************** inserer_un_chiffre ****************************/
// position � ins�rer suppos�e nulle.
...
#else /*AGNES_VERSION*/
/**************************** inserer_un_chiffre ****************************/
// position � ins�rer prealablement effacee.
...
/******************************************************************************
 Bibliotheque pour le lancer al�atoire d'un d� (valeurs obtenues entre 1 et 6)
*******************************************************************************/
...
short int LancerDe( void )
	...
	if (premier_appel==1) 	   /* pour �viter de d�marrer tjs de la meme facon */
		{
		srand(time(&temps));
		premier_appel = 2;
		}
